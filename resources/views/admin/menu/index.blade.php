        ...
        <div class="col-md-6 col-sm-6 col-xs-6">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <div class="form-group">
                        <label class=" col-md-2 col-sm-2 col-xs-12" for="seo_title">@lang('admin/common.seo_title')</label>
                        <div class="col-md-10 col-sm-10 col-xs-12">
                    ...
                    <div class="form-group">
                        <label class=" col-md-2 col-sm-2 col-xs-12" for="seo_keyword">@lang('admin/common.seo_keyword')</label>
                        <div class="col-md-10 col-sm-10 col-xs-12">
                        ...
                        @forelse($models as $model)
                            <li id="items-{{$model->id}}" style="height: 50px;vertical-align: middle;list-style: none;line-height: 50px;cursor: move;padding: 0 10px;" class="ui-state-default">
                                ...
                                <div class="pull-right" style="vertical-align: middle;color:#fff;">
                                    <a href="{{url_admin('menu', [$model->id, 'edit'])}}" class="btn btn-default btn-sm"><i class="fa fa-edit"></i></a></div>
                            </li>
                        @empty
                        @endforelse
                    </ul>
