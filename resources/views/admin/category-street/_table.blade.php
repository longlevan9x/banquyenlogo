...
<tr>
    ...
    <td class="vertical-middle">{{$model->getParentName(\App\Models\Category::TYPE_DISTRICT)}}</td>
    ...
    <td class="col-lg-1 col-md-1 col-sm-1 col-xs-1 vertical-middle">
        @include('admin.layouts.widget.button.button_link.action-text', ['url' => \App\Http\Controllers\Admin\CategoryStreetController::getUrlAdmin($model->id),])
    </td>
</tr>