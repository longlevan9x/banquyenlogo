        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                {{ Form::model(isset($model) ? $model : null, [
                    'url' => \App\Http\Controllers\Admin\ExpertController::getUrlAdmin(isset($model) ? $model->id : ''),
                    'files' => true,
                ...
                <div class="col-md-3">
                    ...
                    <div class="form-group">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            @include('admin.layouts.widget.button.button_link.button', ['text' => __('admin.backButton'), 'icon' => 'fa-mail-reply', 'btn_type' => 'default', 'url' => url('expert'), 'btn_size' => 'md'])
                        </div>
                    </div>
                    {{--Seo--}}
                    <br>
