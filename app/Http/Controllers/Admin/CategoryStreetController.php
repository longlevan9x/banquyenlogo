...
class CategoryStreetController extends Controller
{
	...
	public function index() {
		$models = Category::where('type', Category::TYPE_STREET)->get();

		return view('admin.category-street.index', compact('models'));
	}
	...
	public function store(CategoryRequest $request) {
		...
		$model->type = Category::TYPE_STREET;
		$model->save();
